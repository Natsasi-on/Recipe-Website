    ...
    <div class="highlight-section">
        ...
        <div class="flex-row parent-highlight">
            ...
            try {
                ...
                HAVING round_rate>4
                LIMIT 3;";
                // prevent SQL injection attacks by eliminating the need to manually quote and escape the parameters.
    ...
    <div class="blog-menu-section">
        ...
        <div class="blog-row">
            ...
            <p>Pad kaphrao consists of meat such as pork, chicken, beef, and seafood stir fried with Thai holy
                basil and garlic. It is served with rice and topped up (optional) with fried eggs or khai dao. The
                main seasonings are soy sauce, Thai fish sauce, oyster sauce (optional), cane sugar, and bird's eye
                chili.
            </p>
        </div>
        <div class="blog-row">
            ...
            <p>Consumed typically with jasmine rice, Kana Moo Krob is Chinese broccoli that is stir-fried over high
                heat and tossed with garlic, chili, and crunchy pork belly, topped with soybean sauce and oyster
                sauce to give it a sweet and salty taste.
            </p><br>
